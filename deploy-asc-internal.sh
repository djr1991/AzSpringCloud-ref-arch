...
hub_vnet_resource_group_name='hub-vnet-rg2' #Hub Virtual Network Resource Group name
...
azurespringcloud_service='azspringcloud-dylanjreed-test' #Name of Spring Cloud resource
azurespringcloud_service_runtime_resource_group_name='azspringcloud-service-runtime-rg-test' #Name of Azure Spring Cloud service runtime resource group	
azurespringcloud_app_resource_group_name='azspringcloud-apps-rg-test' #Name of Azure Spring Cloud apps resource group
